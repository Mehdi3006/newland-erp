...
@Component
public final class ServiceWarrantySecurityAdapter implements ServiceWarrantySecurityPort {
  private final IdentityAuthorizationPort identity;

  public ServiceWarrantySecurityAdapter(
  ...
  public void require(final String actor, final String capability, final UUID companyId) {
    ...
    if (!current.equals(actor)
      ...
      throw new AccessDeniedException("Service permission denied for company scope.");
    }
  }
