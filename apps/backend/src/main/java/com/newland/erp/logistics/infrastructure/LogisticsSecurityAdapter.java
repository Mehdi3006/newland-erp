...
@Component
public final class LogisticsSecurityAdapter implements LogisticsSecurityPort {
  private final IdentityAuthorizationPort identity;

  public LogisticsSecurityAdapter(final IdentityAuthorizationPort identityAuthorizationPort) {
  ...
  public void require(final String actor, final String capability, final UUID companyId) {
    ...
    if (!current.equals(actor)
      ...
      throw new AccessDeniedException("Logistics permission denied for company scope.");
    }
  }
