package com.newland.erp.enterprise;
...
final class EnterpriseStructureArchitectureTest {
    private static final String BASE_PACKAGE = "com.newland.erp.enterprise";
    ...
    @Test
    void apiDoesNotDependOnInfrastructureOrPersistence() {
        ArchRuleDefinition.noClasses()
                .that()
                .resideInAPackage(BASE_PACKAGE + ".api..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage(BASE_PACKAGE + ".infrastructure..", "org.jooq..")
                .check(CLASSES);
    }

    @Test
    void applicationDoesNotDependOnApiInfrastructureOrPersistence() {
        ArchRuleDefinition.noClasses()
                .that()
                .resideInAPackage(BASE_PACKAGE + ".application..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage(BASE_PACKAGE + ".api..", BASE_PACKAGE + ".infrastructure..", "org.jooq..")
                .check(CLASSES);
    }
}
