...
- Completed Phase P3.10 CRM foundation for company-scoped leads, controlled qualification and
  conversion, opportunities with auditable stage transitions, immutable customer activities,
  customer timelines, published Sales customer references, audit, and transactional outbox events.
