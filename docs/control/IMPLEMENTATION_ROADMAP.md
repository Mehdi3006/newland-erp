...
| P3.3.5 | Shared Product Catalog             | Implement product, SKU, code, barcode, category/brand/family assignment, attributes, UOM assignment, packaging, measurements, media, localized content, tags, search metadata, and warranty metadata. | Under P3.3.5 PR review; no inventory/pricing.          |
