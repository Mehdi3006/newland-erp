...
| ----- | ---------------------------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| P3.1  | Enterprise Structure               | Implement enterprise, legal entity, company, branch, warehouse, zone, and location foundations. | Under PR #11 review; project/scope expansion deferred. |
| P3.2  | Identity and Access                | Implement users, roles, permissions, scopes, and audit.                                         | Authentication provider and role policy.               |
