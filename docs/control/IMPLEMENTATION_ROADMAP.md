...
| P3.6   | Sales Foundation                   | Implement customer, quotation, sales order, reservation request, delivery request, amendment, cancellation, and partial-fulfilment foundations.                                                       | Under P3.6 implementation; no AR/accounting/pricing.   |
| P3.7   | Import Logistics                   | Implement shipment, container, customs milestones, landed-cost draft.                                                                                                                                 | Logistics/customs fields and cost basis.               |
