...
| P3.7   | Finance Foundation                 | Implement chart of accounts, fiscal periods, journal drafting/posting/reversal, financial dimensions, and explicit future finance posting contracts.                                                  | Under P3.7 implementation; no AP/AR/auto-posting.      |
| P3.8   | Import Logistics                   | Implement shipment, container, customs milestones, landed-cost draft.                                                                                                                                 | Logistics/customs fields and cost basis.               |
