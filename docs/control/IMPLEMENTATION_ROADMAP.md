...
| ----- | ---------------------------------- | ----------------------------------------------------------------------------------- | ---------------------------------------------------- |
| P3.1  | Enterprise Structure               | Implement company, legal entity, branch, warehouse, project, and scope foundations. | Legal/company/branch/warehouse list and scope rules. |
