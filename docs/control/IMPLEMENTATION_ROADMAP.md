...
| P3.2.5 | Platform Foundation                | Implement shared infrastructure: event bus, outbox, audit, jobs, storage, configuration, flags, cache, localization, and catalogs. | Under P3.2.5 PR review; no business modules.           |
