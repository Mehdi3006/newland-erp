...
| P3.5   | Procurement Foundation             | Implement supplier, supplier product reference, requisition, approval, RFQ, supplier quotation, comparison, purchase order, amendment, cancellation, and partial-delivery foundations.                | Under P3.5 PR review; no AP/accounting/stock mutation. |
