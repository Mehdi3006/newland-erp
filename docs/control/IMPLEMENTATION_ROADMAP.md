...
| P3.3   | Master Data                        | Implement enterprise reference-data foundation for organization, geography, currency, UOM, tax, payment, shipping, fiscal, numbering, document, attachment, and product-classification references. | Under P3.3 PR review; no operational logic.            |
| P3.3.x | Product Information Management     | Implement product, SKU, packaging, and lifecycle after Master Data is approved.                                                                                                                    | SKU/model/traceability policy.                         |
